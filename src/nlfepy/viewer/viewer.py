...
class Viewer:
    ...
    def get_frame_imgs(self, *, fig_cnfs: list, vtk_cnf: dict = {}, **kwargs) -> list:
        ...
        for inum in vtk_num_list:
            self.multi_plot(os.path.join(vtk_cnf['dir'], vtk_cnf['header'] + str(inum) + vtk_cnf['ext']), fig_cnfs, **kwargs)
    ...
    def save_figs(self, *, fig_cnfs: list, vtk_cnf: dict = {}, **kwargs) -> None:
        ...
        for inum in vtk_num_list:
            vtk_path = os.path.join(vtk_cnf['dir'], vtk_cnf['header'] + str(inum) + vtk_cnf['ext'])
